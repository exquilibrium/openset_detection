...
TRAIN_SET="${BASE_VOC_FOLDER}/VOCdevkit_xml/VOC0712/ImageSets/YOLO_CS/train.txt"
VAL_SET="${BASE_VOC_FOLDER}/VOCdevkit_xml/VOC0712/ImageSets/YOLO_CS/val.txt"
TEST_SET="${BASE_VOC_FOLDER}/VOCdevkit_xml/VOC0712/ImageSets/YOLO/test.txt"
OOD_SET="${BASE_VOC_FOLDER}/VOCdevkit_xml/VOC0712/ImageSets/YOLO_CS/test_ood.txt"
# === SET PATH TO DATASET DIRECTORY!!! ===
