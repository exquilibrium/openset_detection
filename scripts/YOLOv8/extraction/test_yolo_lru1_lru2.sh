...
TRAIN_SET="/volume/hot_storage/slurm_data/chen_le/ARCHES/lru1_all/ImageSets/YOLO_CS_lru2/train.txt"
VAL_SET="/volume/hot_storage/slurm_data/chen_le/ARCHES/lru1_all/ImageSets/YOLO_CS_lru2/val.txt"
TEST_SET="/volume/hot_storage/slurm_data/chen_le/ARCHES/lru1_all/ImageSets/YOLO/test.txt"
OOD_SET="/volume/hot_storage/slurm_data/chen_le/ARCHES/lru1_all/ImageSets/YOLO_CS_lru2/test_ood.txt"
# === SET PATH TO DATASET DIRECTORY!!! ===
