...
TRAIN_SET="${BASE_DATA_FOLDER}/lru1_all/ImageSets/YOLO_CS_${CS}/train.txt"
VAL_SET="${BASE_DATA_FOLDER}/lru1_all/ImageSets/YOLO_CS_${CS}/val.txt"
TEST_SET="${BASE_DATA_FOLDER}/lru1_all/ImageSets/YOLO/test.txt"
OOD_SET="${BASE_DATA_FOLDER}/lru1_all/ImageSets/YOLO_CS_${CS}/test_ood.txt"
# === SET PATH TO DATASET DIRECTORY!!! ===
