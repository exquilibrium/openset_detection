...
TRAIN_SET="${BASES_DATA_FOLDER}/ardea10_all/ImageSets/YOLO/train.txt"
VAL_SET="${BASES_DATA_FOLDER}/ardea10_all/ImageSets/YOLO/val.txt"
TEST_SET="${BASES_DATA_FOLDER}/ardea10_all/ImageSets/YOLO/test.txt"
OOD_SET="${BASES_DATA_FOLDER}/ardea10_all/ImageSets/YOLO/test_ood.txt"
# === SET PATH TO DATASET DIRECTORY!!! ===
