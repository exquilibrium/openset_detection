...
def associate_detections(dataHolder, dets, gt, clsCutoff):
		gtBoxes = gt['bboxes']
		gtLabels = gt['labels']
		...
		clsCutoff = np.array(clsCutoff, dtype=gtLabels.dtype)
		# Create masks
		unknown_mask = np.isin(gtLabels, clsCutoff)
		known_mask = ~unknown_mask
		# Apply masks
		knownBoxes = gtBoxes[known_mask]
		knownLabels = gtLabels[known_mask]
		unknownBoxes = gtBoxes[unknown_mask]
		unknownLabels = gtLabels[unknown_mask]
